  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="sicoApp.country.detail.title">Country</Translate> [<b>{countryEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            <dt>
              <span id="countryName">
                <Translate contentKey="sicoApp.country.countryName">Country Name</Translate>
              </span>
            </dt>
            <dd>{countryEntity.countryName}</dd>
            <dt>
              <Translate contentKey="sicoApp.country.region">Region</Translate>
            </dt>
